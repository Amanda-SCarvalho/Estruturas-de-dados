...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        // length é utilizado para verificar a quantidade de elementos no vetor
        ...
        System.out.println(Arrays.toSpring);

        int[] meu_array2 = meu_array.clone();

        // nao permiti atribui dessa maneira

        // manualmente
        int[] meu_array3 = new int[5];
        meu_array[0] = meu_array[0];
        meu_array[1] = meu_array[1];
        meu_array[2] = meu_array[2];
        meu_array[3] = meu_array[3];
        meu_array[4] = meu_array[4];
        ...
        int[] meu_array5 = new int[5];
        System.out.println(Arrays.toString(meu_array2));

        Spring[] discentes = Arrays.copyOf(alunos,newLength:5);
        System.out.println(Arrays,toString(discentes));

        //Organizando pela função: SORT
        int[] des ={10,5,6,0,1,3,2,4,6,7,9};
        System.out.println(Arrays,toString(des));
        Arrays.sort(des);
        System.out.println(Arrays.toSpring(aluno));

        System.out.println(aluno[3]);

        int[] meu_array6 = new int[5];
    Arrays.fill(meu_array6, val:2);
    ...
    // quando as tipagens sao diferentes o equals nao funciona, exemplo errado:
