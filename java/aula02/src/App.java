...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        // é utilizado quando não se sabe o conteudo dos elementos, porém você sabe o
        // limite de elementos a serem guardados

        // tipo_dado[] nome_array = new tipo_dado[tamanho]
        int[] meu_array = new int[5]; // declaração do vetor de inteiro com tamanho 5

        // Acesso rápido para guardar valores / inicialização de valores
        meu_array[0] = 10;
        meu_array[1] = 20;
        meu_array[2] = 30;
        meu_array[3] = 40;
        ...
        // usa o length para saber a capacidade do array
        ...
        // converter em texto um array, usando o array aluno
        ...
        // organiza os elementos de um array em ordem crescente
        ...
        // UTILIZANDO A FUNÇÕA FILL: insere um valor em todos os elementos da array
        int[] meu_array6 = new int[5];
        Arrays.fill(meu_array6, 2); // prenche todos os elementos com 2
        System.out.println(Arrays.toString(meu_array6));

        // UTILIZANDO A FUNÇÃO: EQUALS
        // Compara os elementos de duas arrays com o mesmo tamanho
        boolean res = Arrays.equals(meu_array, meu_array2); //retorna verdadeiro ou falso
